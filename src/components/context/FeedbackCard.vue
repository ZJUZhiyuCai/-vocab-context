      ...
      >
        ...
        <div class="space-y-4 mb-6">
          ...
          <div :class="['p-4 rounded-2xl border', isDark ? 'bg-emerald-500/5 border-emerald-500/10' : 'bg-emerald-50 border-emerald-200']">
            <p :class="['text-xs font-medium mb-1', isDark ? 'text-emerald-400' : 'text-emerald-600']">
              English Definition
            </p>
        ...
        <!-- Collocations -->
        <div
          v-if="bundle?.collocations?.length"
          class="mb-6"
        >
        ...
        <!-- Paraphrases -->
        <div
          v-if="bundle?.paraphrases?.length"
          class="mb-6"
        >
          <p :class="['text-xs font-medium mb-2', isDark ? 'text-gray-400' : 'text-gray-600']">
            同义改写
        ...
        >
          <div class="grid grid-cols-3 gap-4 text-center">
            <div>
              <p :class="['text-xs mb-1', isDark ? 'text-gray-400' : 'text-gray-600']">
                释义
              </p>
