  ...
  <div class="exam-drill-card">
    ...
    <div class="group relative">
      ...
      >
        ...
        <div
          v-if="task.surfaceType === 'reading_paraphrase'"
          class="space-y-6"
        >
          <div :class="['p-5 rounded-2xl border', isDark ? 'bg-amber-500/5 border-amber-500/10' : 'bg-amber-50 border-amber-200']">
            <p :class="['text-xs font-medium mb-2', isDark ? 'text-amber-400' : 'text-amber-600']">
              阅读语境
            </p>
            ...
            <p
              v-if="task.contextTranslation"
              :class="['text-sm mt-2', isDark ? 'text-amber-300/50' : 'text-amber-700/70']"
            >
        ...
        <div
          v-else-if="task.surfaceType === 'listening_paraphrase'"
          class="space-y-6"
        >
          <div :class="['p-5 rounded-2xl border', isDark ? 'bg-cyan-500/5 border-cyan-500/10' : 'bg-cyan-50 border-cyan-200']">
            <div class="flex items-center gap-2 mb-2">
              ...
              <p :class="['text-xs font-medium', isDark ? 'text-cyan-400' : 'text-cyan-600']">
                听力文本（模拟）
              </p>
            </div>
            ...
            <p
              v-if="task.transcriptTranslation"
              :class="['text-sm mt-2', isDark ? 'text-cyan-300/50' : 'text-cyan-700/70']"
            >
        ...
        <div
          v-else-if="task.surfaceType === 'writing_argument'"
          class="space-y-6"
        >
          <div :class="['p-5 rounded-2xl border', isDark ? 'bg-violet-500/5 border-violet-500/10' : 'bg-violet-50 border-violet-200']">
            <p :class="['text-xs font-medium mb-2', isDark ? 'text-violet-400' : 'text-violet-600']">
              IELTS Writing Task 2 风格
            </p>
          ...
          <div class="mb-4">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <span
                v-if="task.collocation && task.collocation !== task.word"
                :class="[
                  'px-3 py-1.5 rounded-xl text-sm font-medium border',
        ...
        <div
          v-else-if="task.surfaceType === 'speaking_frame'"
          class="space-y-6"
        >
          <div :class="['p-5 rounded-2xl border', isDark ? 'bg-rose-500/5 border-rose-500/10' : 'bg-rose-50 border-rose-200']">
            <div class="flex items-center gap-2 mb-2">
              ...
              <p :class="['text-xs font-medium', isDark ? 'text-rose-400' : 'text-rose-600']">
                IELTS Speaking 风格
              </p>
            </div>
