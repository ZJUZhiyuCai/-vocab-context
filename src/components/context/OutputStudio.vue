  ...
  <div class="output-studio animate-slide-right">
        ...
        >
          <div :class="['summary-card', isDark ? 'dark' : 'light']">
            ...
            <div class="stats-row">
              ...
              <div :class="['stat-item', isDark ? 'dark' : 'light']">
                <div class="stat-value text-gray-400">
            ...
            >
              ...
              <div :class="['coach-card', isDark ? 'dark' : 'light']">
                ...
                <div
                  v-if="summary.coach.strengths?.length"
                  class="coach-block"
                >
                  ...
                  <div class="coach-chip-row">
                    <span
                      v-for="item in summary.coach.strengths"
                      :key="item"
                ...
                <div
                  v-if="summary.coach.focusAreas?.length"
                  class="coach-block"
                >
                  <p :class="['coach-label', isDark ? 'text-gray-400' : 'text-gray-500']">
                    下一轮重点补强
                  ...
                  <div class="coach-chip-row">
                    <span
                      v-for="item in summary.coach.focusAreas"
                      :key="item"
                ...
                <div
                  v-if="summary.coach.weakWords?.length"
                  class="coach-block"
                >
                  <p :class="['coach-label', isDark ? 'text-gray-400' : 'text-gray-500']">
                    建议立刻重练
    ...
    >
      <section :class="['hero-card', isDark ? 'dark' : 'light']">
        <div class="hero-copy">
          ...
          <div
            ...
            :class="['last-summary last-summary-violet', isDark ? 'dark' : 'light']"
          >
      ...
      <div class="stats-grid">
        ...
        <div :class="['stat-card', isDark ? 'dark' : 'light']">
          <div class="stat-value text-fuchsia-500">
            {{ history.totalOutputs }}
          </div>
          <div class="stat-label">
            产出总数
          </div>
